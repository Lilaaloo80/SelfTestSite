...
if (isset($_COOKIE['guitarTestResult'])) {
    // cookie exists, display results
    $result = $_COOKIE['guitarTestResult'];
    echo " $result";
} else {
    // cookie does not exist, display form
    echo "<form method='POST' action='guitar-test.php'>";
...
<div id="quiz-container">
    ...
    <form id="quiz-form" method="post" action="../pages/process-form.php">
        ...
        <div id="question-4" class="question">
            ...
            <label><input type="radio" name="q4" value="50"> Acoustic</label><br>
            <label><input type="radio" name="q4" value="30"> Semi-Acoustic</label><br>
            <label><input type="radio" name="q4" value="80"> Electric</label><br>
